                ...
                <div className="hidden md:block">
                  <div className="ml-5 flex items-baseline space-x-4">
                    ...
                    { auth.userInfo && auth.userInfo.isAdmin ? 
                      <Link to="/admin" className="text-santander-red hover:bg-santander-red hover:text-white px-3 py-2 rounded-md text-sm font-medium">
                        Admin
                      </Link>
                    : <></> }
                    <button onClick={handleLogout} className="text-gray-800 hover:bg-gray-600 hover:text-white px-3 py-2 rounded-md text-sm font-medium">
                      Logout
                    </button>
                  </div>                  
                </div>
